...
PID myPid(&pidInput, &pidOutput, &pidSetpoint, 0.01, 0.3, 0.001, REVERSE); //4, 1, 0 jerky start but stays constant
...
double powerMax = 255; // turntable can get stuck if this is too low
