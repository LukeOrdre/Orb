...
double powerMin = 32; // dependent on voltage. 28 gives steady rotation, less stutters
double powerMax = 70;
...
unsigned long startTime, lastPowerUpdate, prevClickTime, thisClickTime;
...
//    if(clickCount < 20)
//    {
//        myPID.SetTunings(1, 0.1, 0);
//    }
//    if(clickCount > 19 && clickCount < 25)
//    {
//      myPID.SetTunings(13, 3, 0.01);
//    }
//  
    if(millis() - thisClickTime > targetClickTime)
    avgClickTime = millis() - thisClickTime;
...
{
  clickCount++;
  prevClickTime = thisClickTime;
  thisClickTime = millis();
  updateTiming();
}
...
void updateTiming()
{
  ...
  avgClickTime = thisClickTime - prevClickTime;
}
