  ...
  else
  {
    ...
    if (now % clickWindow == 0 && now != lastUpdateTime && clickTarget != 0)
    {
      ...
      else
      {
        ...
        turntableSpeed = (0.99 * turntableSpeed) + (0.01 * instantTurntableSpeed);
      }
    ...
    if (now % 40 == 0)
    {
      Serial.print(10*turntableSpeed);
      Serial.print("\t");
      Serial.print(10*pidSetpoint);
      Serial.print("\t");
...
void getInstruction()
{
    ...
    switch (incomingCharacter) {
      ...
      case '1':
        ...
        clickWindow = 37; // 4 for metronome
